function checkBirthday(event) {
    ...
    if (birthDay == currentDay && birthMonth == currentMonth) {
        ...
        alert('No birthday today.');
    }
    document.getElementById("birthDay").innerHTML = "birthDay: " + birthDay;
    document.getElementById("currentDay").innerHTML = "currentDay: " + currentDay;
    document.getElementById("birthMonth").innerHTML = "birthMonth:" + birthMonth;
    document.getElementById("currentMonth").innerHTML = "currentMonth" + currentMonth;
}
...
// Call the function to populate the dropdown when the DOM content is loaded
